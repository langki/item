...
function banner() {
    ...
    // 图片数
    var lis = $("#slider").find("ul:first-child li").length;
    ...
    var timer = setInterval(function () {
        ...
        $(pointBox).find("li").removeClass("now");
        $(pointBox).find("li:nth-child("+index+")").addClass("now");
    ...
    // Utools.transitionEnd(imageBox, function() {
    //     if (index >= 4) {
    //         index = 1;
    //         /*瞬间定位*/
    //         /*去除过度*/
